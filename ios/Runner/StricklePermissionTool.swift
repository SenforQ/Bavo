...
class StricklePermissionTool {
    //: static let shared = AppPermissionTool()
    static let shared = StricklePermissionTool()

    /// 获取麦克风权限
    //: func requestMicPermission(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    func fade(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
    ...
    func kick(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
        //: if #available(iOS 14, *) {
        if #available(iOS 14, *) {
    ...
    func past(authBlock: @escaping (_ auth: Bool, _ isFirst: Bool) -> Void) {
